    ...
    <body>
        ...
        <div class="slider-area">
            <div class="slider-active owl-dot-style owl-carousel">
                <div class="single-slider pt-215 pb-228 bg-img" style="background-image:url(img/slider/slider-2.jpg);">
                    <div class="container">
                ...
                <div class="single-slider pt-215 pb-228 bg-img" style="background-image:url(img/slider/slider-3.jpg);">
                    <div class="container">
                        <div class="slider-content slider-content-white slider-animated-2 text-center">
                            <h3 class="animated">We keep pets for pleasure.</h3>
                            <h1 class="animated">Standard Food & Vitamins <br>For all Pets</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="single-food-category-2 text-center mb-30">
                            <div class="single-food-hover">
                                <img src="img/product/food-catigory-1.png" alt="">
                            </div>
                            <h3>Dogs Food</h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single-food-category-2 text-center mb-30">
                            <div class="single-food-hover">
                                <img src="img/product/food-catigory-2.png" alt="">
                            </div>
                            <h3>Cats Food</h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single-food-category-2 text-center mb-30">
                            <div class="single-food-hover">
                                <img src="img/product/food-catigory-3.png" alt="">
                            </div>
                            <h3>Fishs Food</h3>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10 ml-auto mr-auto">
                        <div class="testimonial-wrap testimonial-white-color">
                            ...
                            <div class="testimonial-shap">
                                <img src="img/icon-img/testi-shap-2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="deal-area bg-img deal-style-white pt-95 pb-100 bg-img" style="background-image:url(img/banner/banner-2.jpg);">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="deal-img wow fadeInLeft">
                            <a href="#"><img src="img/banner/banner-4.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
		    ...
		    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.blade.php"><img alt="" src="img/blog/blog-1.jpg"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.blade.php"><img alt="" src="img/blog/blog-2.jpg"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.blade.php"><img alt="" src="img/blog/blog-3.jpg"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <ul>
